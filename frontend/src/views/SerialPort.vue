    ...
    <div class="flex md:flex-row flex-col flex-1 overflow-hidden">
      ...
      <div
        ...
        <div class="bg-mk-surface mb-4 p-4 rounded-xl">
          <h3 class="mb-3 font-medium text-mk-cyan text-sm">串口参数</h3>
          <div class="space-y-3">
            <div class="flex items-center gap-2">
              <span class="w-16 text-mk-green text-sm shrink-0">端口名</span>
            ...
            <div class="flex items-center gap-2">
              <span class="w-16 text-mk-green text-sm shrink-0">波特率</span>
            ...
            <div class="flex items-center gap-2">
              <span class="w-16 text-mk-green text-sm shrink-0">数据位</span>
            ...
            <div class="flex items-center gap-2">
              <span class="w-16 text-mk-green text-sm shrink-0">校验位</span>
            ...
            <div class="flex items-center gap-2">
              <span class="w-16 text-mk-green text-sm shrink-0">停止位</span>
